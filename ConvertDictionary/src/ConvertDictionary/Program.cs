        ...
        public static void Main(string[] args)
        {
            ...
            foreach (KeyValuePair<string, string> kvp in myDictionary)
            {
                ...
                if (kvp.Key.Length <= 8 && kvp.Key.Length >= 3)
                    File.AppendAllText(@"C:\Users\becky\OneDrive\Brooks Stuff\Projects\Word Game\ConvertDictionary\dictionary of short words.txt", string.Format("{0}{1}", kvp.Key, Environment.NewLine));
            }
        }
    }
}
